...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string zh, string en)> M = new()
    {
        ...
        ["chat.dlgRounds"] = ("討論回合", "Rounds"),
        ["chat.dlgRoundsHint"] = ("一回合＝每個人各發言一次；討論中可以隨時按右鍵「結束討論」提前收尾",
                                  "One round = everyone speaks once; you can end early any time with right-click → End discussion"),
        ["chat.hostRole"] = ("主持人", "Host"),
        ["chat.hostFixed"] = ("AI 聊天室的 Agent-x1 固定擔任主持人", "In AI Chat Room, Agent-x1 is always the host"),
        ["chat.rounds"] = ("{0} 回合", "{0} rounds"),
        ...
        ["chat.dlgHint"] = ("開啟後會先問你討論主題，然後由下方的 Agent-x1（主持人）帶著大家一回合一回合發言；每個人都看得到別人已經說過的話，最後由主持人寫結論。\n討論紀錄寫在 .ai/chat/<時間>/ 底下。第一次在新資料夾使用時，請先到每一格回答 AI 的「信任此資料夾」提示。",
        ...
        ["chat.newTopicAsk"] = ("討論已經在進行中，換主題會從第 1 回合重新開始（目前的紀錄會留著）。要換嗎？",
        ...
        ["chat.turnPrompt"] = ("[AwayTerminal] 第 {0}/{1} 回合，輪到你（{2}）發言：請先讀 {3} 看大家說了什麼，再把你的發言寫進 {4}（300 字以內，UTF-8），寫完就好，不用等別人。",
        ...
        ["chat.conclusionPrompt"] = ("[AwayTerminal] 討論結束（共 {0} 回合）。請讀 {1}，整理成結論寫進 {2}（600 字以內，UTF-8），並在你的畫面上把結論顯示給使用者看。",
