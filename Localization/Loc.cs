...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string zh, string en)> M = new()
    {
        ...
        // 1.2.0：Multi-Agent 分頁
        ["ma.title"] = ("Multi-Agent", "Multi-Agent"),
        ["ma.menuSetup"] = ("Multi-Agent 設定…", "Multi-Agent settings…"),
        ...
        ["ma.tooMany"] = ("Multi-Agent 最多同時開 9 組。", "At most 9 Multi-Agent tabs can be open at the same time."),
        ["ma.openFail"] = ("Multi-Agent 沒有任何 agent 啟動成功。", "No agent of this Multi-Agent tab could be started."),
        ...
        ["ma.pickDir"] = ("選擇 Multi-Agent 專案資料夾（四個 agent 都在這裡工作）", "Choose the Multi-Agent project folder (all agents work here)"),
        ...
        ["ma.dlgNotRunning"] = ("未啟用（勾「啟用」後按「套用」即啟動）", "Not enabled (check Enable, then Apply)"),
