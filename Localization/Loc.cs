...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string zh, string en)> M = new()
    {
        ...
        ["ma.menuPause"] = ("暫停投遞", "Pause delivery"),
        ["ma.menuResume"] = ("繼續投遞", "Resume delivery"),
        ...
        ["ma.tipPaused"] = ("已暫停（右鍵「繼續投遞」）", "Paused (right-click → Resume delivery)"),
        ...
        ["ma.dlgFolder"] = ("專案資料夾（所有 agent 共用）", "Project folder (shared by all agents)"),
        ...
        ["ma.dlgRestoreRolesAsk"] = ("要把 common.md 與四個內建角色檔還原成預設內容嗎？\n（你改過的內容會被覆寫；自己新增的角色檔不受影響）",
                                     "Restore common.md and the four built-in role files to their defaults?\n(Your edits to them are overwritten; roles you added yourself are kept.)"),
        ["ma.dlgNoBackend"] = ("這台電腦沒有找到可用的 Coding Agent（ClaudeCode／Codex／OpenCode／GeminiCLI）。請先安裝，或到「新連接 → 自訂…」設定路徑。",
                               "No Coding Agent (ClaudeCode / Codex / OpenCode / GeminiCLI) was found on this computer. Install one, or set its path in New → Custom…."),
        ...
        ["ma.dlgNeedFolder"] = ("請選擇專案資料夾。", "Please choose a project folder."),
        ["ma.dlgFolderMissing"] = ("資料夾不存在：\n{0}", "Folder not found:\n{0}"),
        ["ma.dlgNeedBackend"] = ("{0} 沒有選 Coding Agent。", "{0} has no Coding Agent selected."),
