...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string zh, string en)> M = new()
    {
        ...
        ["ma.dlgRestoreRolesAsk"] = ("要把 common.md 與內建角色檔（PM／SE／Architect／QA／UI/UX Designer）還原成預設內容嗎？\n（你改過的內容會被覆寫；自己新增的角色檔不受影響）",
                                     "Restore common.md and the built-in role files (PM / SE / Architect / QA / UI/UX Designer) to their defaults?\n(Your edits to them are overwritten; roles you added yourself are kept.)"),
